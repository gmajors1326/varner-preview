...
<div id="vf-drawer" class="fixed top-0 left-0 h-full w-80 max-w-[90vw] bg-white z-[201] shadow-2xl -translate-x-full transition-transform duration-300 ease-in-out overflow-y-auto flex flex-col">
    ...
    <div class="flex-1 overflow-y-auto">
        <?php 
        // If we are filtering by category already, maybe hide that section?
        // For now, keep it so users can refine (e.g. just "Compact Tractors" within "Tractors")
        include get_template_directory() . '/partials/filter-sidebar.php'; 
        ?>
    </div>
</div>

<!-- SEO HERO -->
<section class="pt-32 pb-16 bg-slate-950 text-white relative overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto px-4 relative z-10">
        <div class="flex flex-col md:flex-row md:items-end justify-between gap-8">
            <div class="max-w-3xl">
                ...
                <h1 class="text-6xl md:text-8xl font-black tracking-tighter uppercase mb-6 leading-[0.9]"><?php echo esc_html($seo['h1']); ?></h1>
                <p class="text-xl text-slate-400 font-bold leading-relaxed"><?php echo esc_html($seo['sub']); ?></p>
            </div>
