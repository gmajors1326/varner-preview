        ...
        <div class="bg-slate-950 text-white py-2 px-4 border-b border-white/10 relative z-20">
            <div class="max-w-7xl mx-auto flex justify-between items-center text-[10px] font-black uppercase tracking-[0.2em]">
                <div class="flex gap-4 sm:gap-6 items-center flex-wrap">
                    <span>Mon-Fri: <?php echo esc_html( varner_get_theme_setting( 'hours_mon_fri', '8am - 5pm' ) ); ?></span>
                    <span class="hidden sm:inline text-slate-500">|</span>
                    <span class="hidden sm:inline">Sat: <?php echo esc_html( varner_get_theme_setting( 'hours_sat', '9am - Noon' ) ); ?></span>
                    <span class="hidden sm:inline text-slate-500">|</span>
                    <span class="hidden sm:inline">Sun: <?php echo esc_html( varner_get_theme_setting( 'hours_sun', 'Closed' ) ); ?></span>
                </div>
        ...
        <header class="bg-white flex flex-col w-full relative z-10">
            ...
            <div class="max-w-7xl mx-auto px-4 py-4 md:py-5 flex items-center justify-between w-full relative">
                ...
                <div class="hidden lg:flex absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center justify-center z-10 pointer-events-none pl-20 xl:pl-32 w-[350px]">
                    <a href="<?php echo esc_url( varner_get_theme_setting( 'contact_map_link', 'https://maps.app.goo.gl/bM7LKVmX8K2T7LpK9' ) ); ?>" target="_blank" rel="noopener" class="group flex items-center justify-center gap-1.5 hover:scale-105 transition-transform pointer-events-auto w-full">
                        ...
                        <div class="flex flex-col text-center">
                            <span class="font-black text-slate-900 uppercase tracking-tighter text-2xl leading-none"><?php echo esc_html( varner_get_theme_setting( 'contact_address_line1', '1375 US-50' ) ); ?></span>
                            <span class="font-black text-red-600 uppercase tracking-[0.1em] text-[10px] group-hover:text-slate-900 transition-colors mt-1"><?php echo esc_html( varner_get_theme_setting( 'contact_address_line2', 'Delta, CO 81416' ) ); ?></span>
                        </div>
                    </a>
                </div>

                <div class="flex items-center gap-4 relative z-10">
                    <a href="tel:<?php echo esc_attr( varner_get_theme_setting( 'contact_phone_raw', '9708740612' ) ); ?>" class="bg-red-600 text-white px-6 md:px-8 py-3 md:py-4 rounded-2xl font-black flex items-center gap-2 shadow-lg hover:bg-red-700 transition-all active:scale-95 text-lg md:text-xl">
                        <svg class="w-5 h-5 md:w-6 md:h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path></svg>
                        <span class="hidden sm:inline"><?php echo esc_html( varner_get_theme_setting( 'contact_phone', '(970) 874-0612' ) ); ?></span>
            ...
            <div class="bg-slate-50 border-t border-slate-200 border-b-4 border-red-600 w-full">
                ...
                <div class="max-w-7xl mx-auto px-4">
                    <nav class="flex items-center justify-center gap-6 lg:gap-8 py-4 flex-wrap relative">
                        ...
                        <a href="<?php echo esc_url( varner_get_theme_setting( 'support_hub_parts_link', 'https://www.allpartsstore.com/index.htm?customernumber=CO0612' ) ); ?>" target="_blank" rel="noopener" class="font-black uppercase text-xs tracking-widest text-slate-700 hover:text-red-600 transition-colors flex items-center gap-1">
                            Online Parts Store
                        </a>
