...
<section class="pt-32 pb-24 bg-slate-50 min-h-[60vh]">
    <div class="max-w-7xl mx-auto px-4">
        ...
        <!-- Page header -->
        <div class="mb-10">
            <h1 class="text-5xl font-black text-slate-900 tracking-tighter uppercase mb-4">All Inventory</h1>
            <div class="w-24 h-2 bg-red-600 mb-4"></div>
            <p class="text-lg text-slate-600 font-bold max-w-3xl">Browse our full inventory — new, used, and showroom units available now.</p>
        </div>
