        ...
        <div class="max-w-7xl mx-auto px-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-8 xl:gap-10 mb-16 items-start">
            <div class="lg:col-span-2 flex flex-col items-center lg:items-start">
                ...
                <ul class="space-y-4 text-white text-sm font-bold text-left w-fit">
                    ...
                    <li><a href="<?php echo esc_url( home_url( '/inventory/trailers' ) ); ?>" class="hover:text-red-500 transition-colors">Trailers</a></li>
                ...
                <div class="flex items-center justify-center gap-5 text-white pt-2">
                    ...
                    if ( is_array( $custom_links ) ) {
                        ...
                        foreach ( $custom_links as $link ) {
                            ...
                            $icon_html = $platform_icons[$platform] ?? $platform_icons['custom'];
                            $aria_label = !empty($link['label']) ? $link['label'] : ucfirst($platform);
                            ?>
                            <a href="<?php echo esc_url($url); ?>" target="_blank" rel="noopener" class="hover:text-red-500 transition-colors" aria-label="<?php echo esc_attr($aria_label); ?>">
                                <?php echo $icon_html; ?>
                            </a>
                            <?php
                        }
