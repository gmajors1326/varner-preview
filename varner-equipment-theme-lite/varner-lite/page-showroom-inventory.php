            ...
            <div class="flex flex-col lg:flex-row gap-8 items-start">
                ...
                <div class="flex-1 min-w-0">
                    ...
                    <div class="bg-white rounded-2xl border border-slate-200 p-16 text-center">
                        ...
                        <a href="<?php echo esc_url( home_url( '/inventory/new/' ) ); ?>" class="inline-block mt-6 bg-red-600 text-white px-6 py-3 rounded-xl font-black uppercase tracking-widest text-xs hover:bg-red-700 transition-colors">
                            Clear All Filters
                        </a>
                    </div>
                    <?php endif; ?>
