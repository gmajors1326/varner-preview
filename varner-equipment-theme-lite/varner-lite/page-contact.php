            ...
            <div class="lg:col-span-2 space-y-8">
                <div class="bg-slate-950 p-8 md:p-12 rounded-[2.5rem] text-white shadow-2xl border-b-4 border-red-600">
                    ...
                    <div class="space-y-8">
                        <div class="flex gap-4">
                            ...
                            <div>
                                <p class="text-xs font-black text-slate-500 uppercase tracking-widest mb-1">Visit Us</p>
                        ...
                        <div class="flex gap-4">
                            ...
                            <div>
                                <p class="text-xs font-black text-slate-500 uppercase tracking-widest mb-1">Call Us</p>
                        ...
                        <div class="flex gap-4">
                            ...
                            <div>
                                <p class="text-xs font-black text-slate-500 uppercase tracking-widest mb-1">Email Us</p>
                ...
                <div class="bg-white p-8 rounded-[2rem] border border-slate-200 shadow-xl">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex justify-between items-center">
                            <span class="text-xs font-black uppercase text-slate-500">Saturday</span>
                        ...
                        <div class="flex justify-between items-center">
                            <span class="text-xs font-black uppercase text-slate-500">Sunday</span>
                ...
                <div class="bg-white rounded-[2.5rem] shadow-2xl border border-slate-200 overflow-hidden">
                    <div class="p-8 md:p-12">
                        <?php if ( isset($_GET['request']) && $_GET['request'] === 'sent' ) : ?>
                            <div class="bg-green-50 border-2 border-green-100 p-8 rounded-3xl mb-12 text-center animate-in fade-in zoom-in duration-500" role="alert" aria-live="polite">
                        ...
                        <form action="<?php echo esc_url( admin_url('admin-post.php') ); ?>" method="POST" class="space-y-8">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div class="space-y-2">
                                    <label for="contact-full-name" class="text-xs font-black uppercase tracking-widest text-slate-500 ml-1">Full Name <span class="text-red-600">(*)</span></label>
                                    <input type="text" name="full_name" id="contact-full-name" required class="w-full bg-slate-50 border-2 border-slate-100 rounded-xl px-5 py-4 font-bold text-slate-900 focus:border-red-500 focus:bg-white outline-none transition-all shadow-sm">
                                </div>
                                <div class="space-y-2">
                                    <label for="contact-email" class="text-xs font-black uppercase tracking-widest text-slate-500 ml-1">Email Address <span class="text-red-600">(*)</span></label>
                                    <input type="email" name="email" id="contact-email" required class="w-full bg-slate-50 border-2 border-slate-100 rounded-xl px-5 py-4 font-bold text-slate-900 focus:border-red-500 focus:bg-white outline-none transition-all shadow-sm">
                                </div>
                            </div>

                            <div class="space-y-2">
                                <label for="contact-phone" class="text-xs font-black uppercase tracking-widest text-slate-500 ml-1">Phone Number</label>
                                <input type="tel" name="phone" id="contact-phone" class="w-full bg-slate-50 border-2 border-slate-100 rounded-xl px-5 py-4 font-bold text-slate-900 focus:border-red-500 focus:bg-white outline-none transition-all shadow-sm">
                            </div>

                            <div class="space-y-2">
                                <label for="contact-message" class="text-xs font-black uppercase tracking-widest text-slate-500 ml-1">Message <span class="text-red-600">(*)</span></label>
                                <textarea name="message" id="contact-message" required rows="6" placeholder="How can we help you today?" class="w-full bg-slate-50 border-2 border-slate-100 rounded-2xl px-6 py-5 font-bold text-slate-900 focus:border-red-500 focus:bg-white outline-none transition-all shadow-sm"></textarea>
                            </div>
