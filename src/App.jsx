  ...
  return (
    <div className="flex flex-col lg:flex-row gap-8 w-full max-w-[1600px] mx-auto animate-in fade-in slide-in-from-bottom-4 duration-500 text-slate-900 pb-16">
      ...
      >
        ...
        {/* STICKY SAVE CONFIGURATION BAR */}
        <div className="sticky bottom-0 bg-white/95 backdrop-blur-md rounded-[2rem] p-5 shadow-2xl border border-slate-200/60 flex items-center justify-between z-20 mt-6">
