...
export function apiToLocal(u) {
  return {
    ...
    category: u.category,
    subcategory: Array.isArray(u.subcategory) ? u.subcategory : (u.subcategory ? [u.subcategory] : []),
    ...
    facebookSync: u.facebook_sync ?? false,
    marketplace_posted: u.marketplace_posted ?? false,
    marketplace_posted_date: u.marketplace_posted_date ?? null,
