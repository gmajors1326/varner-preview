...
<?php
$brand_blurbs = array(
    'Big Tex' => 'Big Tex Trailers has been setting the standard for American-built trailers since 1986. From utility and flatbed to dump and equipment haulers, every Big Tex is engineered for durability and built to handle the toughest jobs — backed by Varner Equipment right here in Delta, Colorado.',
);
$blurb = $brand_blurbs[ $brand_name ] ?? '';
?>

<?php if ( $blurb ) : ?>
<div class="bg-white border-b border-slate-100">
    <div class="max-w-7xl mx-auto px-4 py-5">
        <p class="text-sm font-bold text-slate-500 leading-relaxed max-w-3xl"><?php echo esc_html( $blurb ); ?></p>
    </div>
</div>
<?php endif; ?>
