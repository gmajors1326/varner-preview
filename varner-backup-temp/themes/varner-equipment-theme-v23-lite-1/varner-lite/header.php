        ...
        <header class="bg-white flex flex-col w-full relative z-10">
            ...
            <div class="max-w-7xl mx-auto px-4 py-4 md:py-5 flex items-center justify-between w-full relative">
                ...
                <div class="hidden lg:flex absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center justify-center z-10 pointer-events-none pl-20 xl:pl-32 w-[350px]">
                    <a href="#varner-map" class="group flex items-center justify-center gap-1.5 hover:scale-105 transition-transform pointer-events-auto w-full">
                        ...
                        <div class="flex flex-col text-center">
                            <span class="font-black text-slate-900 uppercase tracking-tighter text-2xl leading-none"><?php echo esc_html($addr_1); ?></span>
                            <span class="font-black text-red-600 uppercase tracking-[0.1em] text-[10px] group-hover:text-slate-900 transition-colors mt-1"><?php echo esc_html($addr_2); ?></span>
                        </div>
                    </a>
                </div>

                <div class="flex items-center gap-2 md:gap-4 relative z-10">
                    <a href="tel:<?php echo esc_attr($phone_tel); ?>" class="bg-red-600 text-white px-4 md:px-8 py-3 md:py-4 rounded-2xl font-black flex items-center gap-2 shadow-lg hover:bg-red-700 transition-all active:scale-95 text-base md:text-xl">
                    ...
                    <!-- MOBILE MENU TOGGLE -->
                    <button id="mobile-menu-toggle" class="lg:hidden p-3 bg-slate-100 text-slate-900 rounded-2xl hover:bg-red-600 hover:text-white transition-all shadow-sm">
            ...
            <div class="hidden lg:block bg-slate-50 border-t border-slate-200 border-b-4 border-red-600 w-full">
                <div class="max-w-7xl mx-auto px-4">
                    <nav class="flex items-center justify-center gap-6 lg:gap-8 py-4 flex-wrap relative">
                        ...
                        <a href="https://www.youtube.com/@VarnerEquipment" target="_blank" class="font-black uppercase text-xs tracking-widest text-slate-700 hover:text-red-600 transition-colors">Product Videos</a>
            ...
            <div id="mobile-menu" class="hidden lg:hidden bg-slate-900 text-white w-full border-t border-white/10 max-h-[80vh] overflow-y-auto">
                <nav class="flex flex-col py-6">
                    ...
                    <a href="<?php echo esc_url( home_url( '/brands' ) ); ?>" class="px-8 py-4 font-black uppercase text-sm tracking-[0.2em] border-b border-white/5 hover:text-red-500">Brands</a>
                    <a href="<?php echo esc_url( home_url( '/finance' ) ); ?>" class="px-8 py-4 font-black uppercase text-sm tracking-[0.2em] border-b border-white/5 hover:text-red-500">Financing</a>
                    ...
                    <div class="border-b border-white/5">
                        ...
                        <div class="hidden bg-white/5 py-2">
                            <a href="<?php echo esc_url( home_url( '/services/service-request' ) ); ?>" class="block px-12 py-3 text-xs font-bold uppercase text-slate-400 hover:text-white">Service</a>
                            <a href="<?php echo esc_url( home_url( '/services/parts-request' ) ); ?>" class="block px-12 py-3 text-xs font-bold uppercase text-slate-400 hover:text-white">Parts</a>
                        </div>
                    </div>
