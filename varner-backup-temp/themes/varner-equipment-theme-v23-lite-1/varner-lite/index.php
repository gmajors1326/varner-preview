<?php 
    ...
    $h_subline         = get_field('hero_subheadline') ?: "Colorado's premier destination for high-performance heavy equipment. Authorized dealer for Mahindra, Big Tex, Deutz-Fahr, and dozens of other world-class agricultural and construction brands.";
        ...
        <div class="relative z-40 max-w-7xl mx-auto px-4 w-full pb-12">
            <div class="max-w-3xl space-y-8">
                <h1 class="text-5xl md:text-8xl font-black text-white leading-[0.9] tracking-tighter uppercase drop-shadow-2xl">
                    ...
                    <span class="text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-red-600"><?php echo $h_headline_accent; ?></span>
                </h1>
                ...
                <div class="flex flex-col sm:flex-row flex-wrap gap-4 pt-6 items-start">
                    ...
                    <a href="<?php echo esc_url( home_url( '/services/parts-request' ) ); ?>" class="relative z-50 bg-white/10 backdrop-blur-md border-2 border-white/20 text-white px-12 py-6 rounded-3xl font-black uppercase tracking-widest text-sm hover:bg-white/20 transition-all">
